...
export default function ProductListScreen() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        console.log("glasgow-6-3-evening-1");
        console.log(data);
  ...
  console.log("glasgow-6-3-evening");
  ...
  // useEffect(() => {
  //   axios
          //     .get(              `/api/products/get-category-info`, {
  //       headers: { Authorization: `Bearer ${userInfo.token}` },
  //     })
    ...
    <Box m="1rem 1.5rem">
      ...
      <Row className="py-2"  >
        ...
        <Col className="col text-end">
          <div >
            <Button className="button-banner-category" style={{ textDecoration: 'none' }} type="button" onClick={createHandler}>
              Export Product
            </Button>
            {/* </div>
